...
/**
 * Multi valued typed config property. Purpose is to support logical groups of config values related
 * to certain configurable component, plus provide their atomic value retrieval, atomic validation,
 * and atomic reload. For example:
 *
 * <pre>
